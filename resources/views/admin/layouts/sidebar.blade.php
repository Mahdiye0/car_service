<aside id="sidebar" class="sidebar">
        ...
        <section class="sidebar-wrapper">
            ...
            <section class="sidebar-group-link">
                ...
                <section class="sidebar-dropdown">
                    <a href="{{ route('admin.type-service')}}">دسته بندی</a>
                    <a href="#">فرم کالا</a>
 ...
 --}}
            ...
            <a href="{{ route('admin.type-service') }}" class="sidebar-link">
                <i class="fas fa-bars"></i>
                <span>خدمات  </span>
            </a>
            ...
            <a href="{{ route('admin.user') }}" class="sidebar-link">
                <i class="fas fa-bars"></i>
                <span>خدمت دهنده</span>
            </a>

            <a href="{{ route('admin.customer') }}" class="sidebar-link">
                <i class="fas fa-bars"></i>
                <span>خدمت گیرنده</span>
            </a>
            <a href="{{ route('admin.user.report-order') }}" class="sidebar-link">
                <i class="fas fa-bars"></i>
                <span>گزارش درخواستها</span>
            </a>
