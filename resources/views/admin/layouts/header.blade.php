                ...
                <section>
                    ...
                    <span class="ml-3 ml-md-5 position-relative">
                        <span id="header-profile-toggle" class="pointer">
                            <img class="header-avatar" src="{{asset(auth()->user()->image)}}" alt="">
                            <span class="header-username">@if (\Auth::check())
                    ...
                    <section id="header-profile" class="header-profile rounded">
                        <section class="list-group rounded">
                            ...
                            <a href="{{ route('admin.user.edit-profile') }}" class="list-group-item list-group-item-action header-profile-link">
